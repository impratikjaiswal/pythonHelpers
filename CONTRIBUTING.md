...
[please create a GitHub discussion](https://github.com/impratikjaiswal/pythonHelpers/discussions/new/choose).
...
If you've an idea in mind, [please submit a feature request](https://github.com/impratikjaiswal/pythonHelpers/discussions/new?category=ideas).
...
If you've noticed a bug, [please submit an issue](https://github.com/impratikjaiswal/pythonHelpers/issues/new).

## Bug Reports Guidelines

1. **Use the GitHub issue search.** Check if the issue has already been
   [reported](https://github.com/impratikjaiswal/pythonHelpers/issues).
...
If this is something you think you can fix, then [fork](https://github.com/impratikjaiswal/pythonHelpers/fork) and create
